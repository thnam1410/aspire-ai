...
public static class PreventStreamingWithFunctionsExtensions
{
    ...
    {
        public override Task<Microsoft.Extensions.AI.ChatCompletion> CompleteAsync(IList<ChatMessage> chatMessages, ChatOptions? options = null, CancellationToken cancellationToken = default)
        {
