...
using Shared.OpenTelemetry.Attributes;

namespace Shared.OpenTelemetry;

/// <summary>
/// Ref: https://github.com/thangchung/practical-dotnet-aspire/blob/main/shared/CoffeeShop.Shared/OpenTelemetry/HandlerBehavior.cs
/// </summary>
    ...
    where TResponse : notnull
{
    public async Task<TResponse> Handle(TRequest request, RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
    {
        ...
        var attr = outerHandler
            .GetType()
            .GetCustomAttribute<IgnoreOTelOnHandlerAttribute>();
